resource "kubernetes_manifest" "serviceaccount_metrics_server" {
...
resource "kubernetes_manifest" "rolebinding_metrics_server_auth_reader" {
  provider = kubernetes-alpha
  manifest = {
    "apiVersion" = "rbac.authorization.k8s.io/v1"
    "kind" = "RoleBinding"
...
resource "kubernetes_manifest" "service_metrics_server" {
  provider = kubernetes-alpha
  manifest = {
    "apiVersion" = "v1"
    "kind" = "Service"
...
resource "kubernetes_manifest" "deployment_metrics_server" {
  provider = kubernetes-alpha
  manifest = {
    "apiVersion" = "apps/v1"
    "kind" = "Deployment"
